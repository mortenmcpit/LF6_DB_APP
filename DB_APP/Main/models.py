...
class Person(db.Model):
    ...
    lastname = db.Column('nachname', db.String())
    firstname = db.Column('vorname', db.String())
    street = db.Column('strasse', db.String())
    place = db.Column('ort', db.String())
    zipcode = db.Column('plz', db.String())
    country = db.Column('land', db.String())
...
class Producer(db.Model):
    ...
    producername = db.Column('herstellername', db.String())
    country = db.Column('land', db.String())
